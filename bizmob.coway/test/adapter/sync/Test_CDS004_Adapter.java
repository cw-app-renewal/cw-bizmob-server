...
public class Test_CDS004_Adapter extends TestAdapter {

	@Autowired
	private CDS004_ADT_HeartInfoSync adapter;
	private JsonAdaptorObject obj = new JsonAdaptorObject();

	@Before
	public void setUp() throws IOException {
		//TODO 요청데이터 입력. JsonAdaptorObject.TYPE.REQUEST
		InputStream in = new FileInputStream(new File("./test/data/sync/CDS004.json"));
