...
public class Test_WR002_Adapter extends TestAdapter {

	@Autowired
	private WR002_Adapter adapter;
	private JsonAdaptorObject obj = new JsonAdaptorObject();

	@Before
	public void setUp() throws IOException {
		//TODO 요청데이터 입력. JsonAdaptorObject.TYPE.REQUEST
		InputStream in = new FileInputStream(new File("./test/data/sample/WR002.json"));
