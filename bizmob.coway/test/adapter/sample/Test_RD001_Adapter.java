...
public class Test_RD001_Adapter extends TestAdapter {

	@Autowired
	private RD001_Adapter adapter;
	...
	public void setUp() throws JsonProcessingException, IOException {
		...
		InputStream in = new FileInputStream(new File("./test/data/sample/RD001.json"));
