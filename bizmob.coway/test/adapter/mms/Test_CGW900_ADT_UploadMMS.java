...
public class Test_CGW900_ADT_UploadMMS extends TestAdapter {

	@Autowired
	private CGW900_ADT_UploadMMS adapter;
	...
	public void setUp() throws IOException {
		...
		InputStream in = new FileInputStream(new File("./test/adapter/mms/CGW900.json"));
