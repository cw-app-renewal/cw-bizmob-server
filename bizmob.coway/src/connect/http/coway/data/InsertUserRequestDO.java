...
public class InsertUserRequestDO {
	...
	private String privateCreateFlag = "";		//개인단말기 자동생성 플래그(기본값:Y)
	...
	public String getPrivateCreateFlag() {
		return privateCreateFlag;
	}
	public void setPrivateCreateFlag(String privateCreateFlag) {
		this.privateCreateFlag = privateCreateFlag;
	}
	...
	public String toString() {
		return "InsertUserDO [userId=" + userId + ", userGroupId="
				...
				+ ", privateCreateFlag=" + privateCreateFlag + "]";
	}
	
	public ArrayList<NameValuePair> getInsertUserNameValueList() {
		...
		qparams.add(new BasicNameValuePair("privateCreateFlag", this.privateCreateFlag));		
