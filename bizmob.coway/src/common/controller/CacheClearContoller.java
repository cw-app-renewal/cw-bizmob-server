...
public class CacheClearContoller {
	...
	public void  getRfcMetaInfo1(@RequestParam("rfcName") String rfcName, HttpServletResponse response) throws IOException {
		
		StringBuffer sb = new StringBuffer();
		sb.append("call :: /select?refName=" + rfcName).append("\n");;
    ...
    @ResponseStatus(HttpStatus.OK)
	public void  getRfcMetaInfo2(@PathVariable("rfcName") String rfcName, HttpServletResponse response) throws IOException {
    ...
    @ResponseStatus(HttpStatus.OK)
	public void RfcCacheClear1(@RequestParam("rfcName") String rfcName, HttpServletRequest request, HttpServletResponse response) throws IOException {
		
		StringBuffer sb = new StringBuffer();
		sb.append("call :: /clear?rfcName=" + rfcName).append("\n");
    ...
    @ResponseStatus(HttpStatus.OK)
	public void RfcCacheClear2(@PathVariable("rfcName") String rfcName, HttpServletRequest request, HttpServletResponse response) throws IOException {
