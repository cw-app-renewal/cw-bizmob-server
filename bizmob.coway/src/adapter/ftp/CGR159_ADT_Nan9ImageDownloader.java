...
@Component
public class CGR159_ADT_Nan9ImageDownloader extends AbstractDownloader implements Downloader {

	private static final Logger logger = LoggerFactory.getLogger(CGR159_ADT_Nan9ImageDownloader.class);
	...
	public void download(String target, String uid, Map<String, Object> params) throws Exception {
		...
		logger.info(String.format(">>>> CGR150_ADT_Nan8ImageDownloader Start downloading from %s : %s", target, uid));
		...
		String fileName = CowayFtpFileName.getWorkNan9ImgName(jobDate, jobType, orderNo, jobSeq, imgSeq);
