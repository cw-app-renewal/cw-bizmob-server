...
@Component
public class CGR142_ADT_UniformImageDownloader extends AbstractDownloader implements Downloader {

	private static final Logger logger = LoggerFactory.getLogger(CGR142_ADT_UniformImageDownloader.class);
	...
	public void download(String target, String uid, Map<String, Object> params) throws Exception {
		...
		logger.info(String.format(">>>> CGR142_ADT_UniformImageDownloader Start downloading from %s : %s", target, uid));
		...
		String filePath = CowayFtpFilePath.getUniformFolder(procId);
		String fileName = CowayFtpFileName.getUnifImgName(orderNo, imgSeq);
