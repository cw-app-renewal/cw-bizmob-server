...
@Component
public class CGR114_ADT_FireImageDownloader extends AbstractDownloader implements Downloader {

	private static final Logger logger = LoggerFactory.getLogger(CGR114_ADT_FireImageDownloader.class);
	...
	public void download(String target, String uid, Map<String, Object> params) throws Exception {
		...
		logger.info(String.format(">>>> CGR114_ADT_FireImageDownloader Start downloading from %s : %s", target, uid));
		...
		String fileName = CowayFtpFileName.getFireImgName(jobDate, jobType, orderNo, jobSeq, imgSeq);
