...
@Component
public class CGR143_ADT_plMovDownloader extends AbstractDownloader implements Downloader {

	private static final Logger logger = LoggerFactory.getLogger(CGR143_ADT_plMovDownloader.class);
	...
	public void download(String target, String uid, Map<String, Object> params) throws Exception {
		...
		logger.info(String.format(">>>> CGR143_ADT_plMovDownloader Start downloading from %s : %s", target, uid));
		...
		String fileName = CowayFtpFileName.getPlmMovName(jobDate, jobType, orderNo, jobSeq);
