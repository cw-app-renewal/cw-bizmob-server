...
@Component
public class CGR145_ADT_opinImageDownloader extends AbstractDownloader implements Downloader {

	private static final Logger logger = LoggerFactory.getLogger(CGR145_ADT_opinImageDownloader.class);
	...
	public void download(String target, String uid, Map<String, Object> params) throws Exception {
		...
		logger.info(String.format(">>>> CGR145_ADT_opinImageDownloader Start downloading from %s : %s", target, uid));
		...
		String filePath = CowayFtpFilePath.getMovieCustFolder(orderNo);
		String fileName = CowayFtpFileName.getOpinImgName(orderNo, imgSeq);
