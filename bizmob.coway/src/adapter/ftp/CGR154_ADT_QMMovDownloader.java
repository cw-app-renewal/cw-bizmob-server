...
@Component
public class CGR154_ADT_QMMovDownloader extends AbstractDownloader implements Downloader {

	private static final Logger logger = LoggerFactory.getLogger(CGR154_ADT_QMMovDownloader.class);
	...
	public void download(String target, String uid, Map<String, Object> params) throws Exception {
		...
		String filePath = CowayFtpFilePath.getQmMovFolder(jobDate);
		String fileName = CowayFtpFileName.getQmMovName(jobDate, orderNo, imgSeq, fileCa);
