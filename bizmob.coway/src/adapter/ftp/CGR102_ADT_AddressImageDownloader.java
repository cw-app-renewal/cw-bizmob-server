...
public class CGR102_ADT_AddressImageDownloader extends AbstractDownloader implements Downloader {
	...
	private ILogger logger = LoggerService.getLogger(CGR102_ADT_AddressImageDownloader.class);
	...
	public void download(String target, String uid, Map<String, Object> params) throws Exception {
		...
		logger.info(String.format("======== CGR102_ADT_AddressImageDownloader Start downloading from %s : %s ", target, uid));
		...
		//address 사진의 경우, 
		//file_name = order_no (고객주문번호)
		//file_path = 2 (고객주소사진구분) 
