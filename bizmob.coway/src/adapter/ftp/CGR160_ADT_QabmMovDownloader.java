...
@Component
public class CGR160_ADT_QabmMovDownloader extends AbstractDownloader implements Downloader {

	private static final Logger logger = LoggerFactory.getLogger(CGR160_ADT_QabmMovDownloader.class);
	...
	public void download(String target, String uid, Map<String, Object> params) throws Exception {
		...
		String fileName = CowayFtpFileName.getWorkQabmMOVName(jobDate, jobType, orderNo, jobSeq);
