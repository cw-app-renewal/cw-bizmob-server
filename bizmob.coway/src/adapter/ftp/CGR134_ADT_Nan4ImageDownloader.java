...
@Component
public class CGR134_ADT_Nan4ImageDownloader extends AbstractDownloader implements Downloader {

	private static final Logger logger = LoggerFactory.getLogger(CGR134_ADT_Nan4ImageDownloader.class);
	...
	public void download(String target, String uid, Map<String, Object> params) throws Exception {
		...
		logger.info(String.format(">>>> CGR134_ADT_Nan4ImageDownloader Start downloading from %s : %s", target, uid));
		...
		String fileName = CowayFtpFileName.getWorkNan4ImgName(jobDate, jobType, orderNo, jobSeq, imgSeq);
