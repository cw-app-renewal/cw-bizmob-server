...
@Component
public class CGR141_ADT_WatermapImageDownloader extends AbstractDownloader implements Downloader {

	private static final Logger logger = LoggerFactory.getLogger(CGR141_ADT_WatermapImageDownloader.class);
	...
	public void download(String target, String uid, Map<String, Object> params) throws Exception {
		...
		logger.info(String.format(">>>> CGR141_ADT_WatermapImageDownloader Start downloading from %s : %s", target, uid));
		...
		String fileName = CowayFtpFileName.getWmapImgName(jobDate, jobType, orderNo, jobSeq, imgSeq);
