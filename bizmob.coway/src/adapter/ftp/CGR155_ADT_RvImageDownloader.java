...
@Component
public class CGR155_ADT_RvImageDownloader extends AbstractDownloader implements Downloader {

	private static final Logger logger = LoggerFactory.getLogger(CGR155_ADT_RvImageDownloader.class);
	...
	public void download(String target, String uid, Map<String, Object> params) throws Exception {
		...
		String filePath = CowayFtpFilePath.getRvimWorkFolder(orderNo, jobDate);
		String fileName = CowayFtpFileName.getRvimImgName(orderNo, jobDate, imgSeq);
