...
@Component
public class CGR163_ADT_WithServiceImageDownloader extends AbstractDownloader implements Downloader {

	private static final Logger logger = LoggerFactory.getLogger(CGR163_ADT_WithServiceImageDownloader.class);
	...
	public void download(String target, String uid, Map<String, Object> params) throws Exception {
		...
		logger.info(String.format(">>>> CGR163_ADT_WithServiceImageDownloader Start downloading from %s : %s", target, uid));
		...
		String filePath = CowayFtpFilePath.getWithFolder(jobDate, jobType, jobSeq);
		String fileName = CowayFtpFileName.getWithImgName(jobDate, jobType, orderNo, jobSeq, imgSeq);
