...
@Component
public class CGR149_ADT_Nan7ImageDownloader extends AbstractDownloader implements Downloader {

	private static final Logger logger = LoggerFactory.getLogger(CGR149_ADT_Nan7ImageDownloader.class);
	...
	public void download(String target, String uid, Map<String, Object> params) throws Exception {
		...
		logger.info(String.format(">>>> CGR149_ADT_Nan7ImageDownloader Start downloading from %s : %s", target, uid));
		...
		String fileName = CowayFtpFileName.getWorkNan7ImgName(jobDate, jobType, orderNo, jobSeq, imgSeq);
