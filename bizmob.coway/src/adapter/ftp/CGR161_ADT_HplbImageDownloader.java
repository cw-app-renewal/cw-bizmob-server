...
@Component
public class CGR161_ADT_HplbImageDownloader extends AbstractDownloader implements Downloader {

	private static final Logger logger = LoggerFactory.getLogger(CGR161_ADT_HplbImageDownloader.class);
	...
	public void download(String target, String uid, Map<String, Object> params) throws Exception {
		...
		logger.info(String.format(">>>> CGR161_ADT_HplbImageDownloader Start downloading from %s : %s", target, uid));
		...
		String filePath = CowayFtpFilePath.getHplbFolder(orderNo);
		String fileName = CowayFtpFileName.getWorkHplbImgName(orderNo, imgSeq);
