...
@Component
public class CGR157_ADT_cPlMovDownloader extends AbstractDownloader implements Downloader {

	private static final Logger logger = LoggerFactory.getLogger(CGR157_ADT_cPlMovDownloader.class);
	...
	public void download(String target, String uid, Map<String, Object> params) throws Exception {
		...
		String fileName = CowayFtpFileName.getCPlMovName(jobDate, jobType, orderNo, jobSeq);
