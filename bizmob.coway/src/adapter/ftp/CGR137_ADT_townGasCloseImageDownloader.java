...
@Component
public class CGR137_ADT_townGasCloseImageDownloader extends AbstractDownloader implements Downloader {

	private static final Logger logger = LoggerFactory.getLogger(CGR137_ADT_townGasCloseImageDownloader.class);
	...
	public void download(String target, String uid, Map<String, Object> params) throws Exception {
		...
		logger.info(String.format(">>>> CGR137_ADT_townGasCloseImageDownloader Start downloading from %s : %s", target, uid));
		...
		String fileName = CowayFtpFileName.getTownGasCloseImgName(orderNo, imgSeq);
