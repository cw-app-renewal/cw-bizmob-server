...
@Component
public class CGR128_ADT_HomeplImageDownloader extends AbstractDownloader implements Downloader {

	private static final Logger logger = LoggerFactory.getLogger(CGR128_ADT_HomeplImageDownloader.class);
	...
	public void download(String target, String uid, Map<String, Object> params) throws Exception {
		...
		logger.info(String.format(">>>> CGR128_ADT_HomeplImageDownloader Start downloading from %s : %s", target, uid));
		...
		String filePath = CowayFtpFilePath.getHomeplFolder(orderNo);
		String fileName = CowayFtpFileName.getHomeplImgName(orderNo, imgSeq);
