...
@Component
public class CGR130_ADT_CoreImageDownloader extends AbstractDownloader implements Downloader {

	private static final Logger logger = LoggerFactory.getLogger(CGR130_ADT_CoreImageDownloader.class);
	...
	public void download(String target, String uid, Map<String, Object> params) throws Exception {
		...
		logger.info(String.format(">>>> CGR130_ADT_CoreImageDownloader Start downloading from %s : %s", target, uid));
		...
		String filePath = CowayFtpFilePath.getCoreFolder(orderNo);
		String fileName = CowayFtpFileName.getCoreImgName(orderNo, imgSeq);
