...
@Component
public class CGR118_ADT_NoinstImageDownloader extends AbstractDownloader implements Downloader {

	private static final Logger logger = LoggerFactory.getLogger(CGR118_ADT_NoinstImageDownloader.class);
	...
	public void download(String target, String uid, Map<String, Object> params) throws Exception {
		...
		logger.info(String.format(">>>> CGR118_ADT_NoinstImageDownloader Start downloading from %s : %s", target, uid));
		...
		String fileName = CowayFtpFileName.getNoinstImgName(jobDate, jobType, orderNo, jobSeq, imgSeq);
