...
@Component
public class CGR150_ADT_Nan8ImageDownloader extends AbstractDownloader implements Downloader {

	private static final Logger logger = LoggerFactory.getLogger(CGR150_ADT_Nan8ImageDownloader.class);
	...
	public void download(String target, String uid, Map<String, Object> params) throws Exception {
		...
		String fileName = CowayFtpFileName.getWorkNan8ImgName(jobDate, jobType, orderNo, jobSeq, imgSeq);
