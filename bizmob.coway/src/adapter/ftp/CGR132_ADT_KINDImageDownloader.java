...
@Component
public class CGR132_ADT_KINDImageDownloader extends AbstractDownloader implements Downloader {

	private static final Logger logger = LoggerFactory.getLogger(CGR132_ADT_KINDImageDownloader.class);
	...
	public void download(String target, String uid, Map<String, Object> params) throws Exception {
		...
		logger.info(String.format(">>>> CGR132_ADT_KINDImageDownloader Start downloading from %s : %s", target, uid));
		...
		String fileName = CowayFtpFileName.getWorkKindImgName(jobDate, jobType, orderNo, jobSeq, imgSeq);
