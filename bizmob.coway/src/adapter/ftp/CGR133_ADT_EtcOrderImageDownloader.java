...
@Component
public class CGR133_ADT_EtcOrderImageDownloader extends AbstractDownloader implements Downloader {

	private static final Logger logger = LoggerFactory.getLogger(CGR133_ADT_EtcOrderImageDownloader.class);
	...
	public void download(String target, String uid, Map<String, Object> params) throws Exception {
		...
		logger.info(String.format(">>>> CGR133_ADT_EtcOrderImageDownloader Start downloading from %s : %s", target, uid));
		...
		String filePath = CowayFtpFilePath.getEtcOrderFolder(orderNo);
		String fileName = CowayFtpFileName.getEtcOrderImgName(orderNo, imgSeq);
