...
@Component
public class CGR156_ADT_cPlrMovDownloader extends AbstractDownloader implements Downloader {

	private static final Logger logger = LoggerFactory.getLogger(CGR156_ADT_cPlrMovDownloader.class);
	...
	public void download(String target, String uid, Map<String, Object> params) throws Exception {
		...
		String fileName = CowayFtpFileName.getCPlrMovName(jobDate, jobType, orderNo, jobSeq, imgSeq);
