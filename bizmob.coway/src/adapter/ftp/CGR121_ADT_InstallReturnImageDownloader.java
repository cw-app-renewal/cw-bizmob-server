...
@Component
public class CGR121_ADT_InstallReturnImageDownloader extends AbstractDownloader implements Downloader {

	private static final Logger logger = LoggerFactory.getLogger(CGR121_ADT_InstallReturnImageDownloader.class);
	...
	public void download(String target, String uid, Map<String, Object> params) throws Exception {
		...
		logger.info(String.format(">>>> CGR121_ADT_InstallReturnImageDownloader Start downloading from %s : %s", target, uid));
		...
		String fileName = CowayFtpFileName.getInstallReturnImgName(orderNo, imgSeq);
