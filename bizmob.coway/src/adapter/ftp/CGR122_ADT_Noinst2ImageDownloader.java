...
@Component
public class CGR122_ADT_Noinst2ImageDownloader extends AbstractDownloader implements Downloader {

	private static final Logger logger = LoggerFactory.getLogger(CGR122_ADT_Noinst2ImageDownloader.class);
	...
	public void download(String target, String uid, Map<String, Object> params) throws Exception {
		...
		logger.info(String.format(">>>> CGR122_ADT_Noinst2ImageDownloader Start downloading from %s : %s", target, uid));
		...
		String fileName = CowayFtpFileName.getNoInst2ImgName(orderNo, imgSeq);
