...
@Component
public class CGR113_ADT_PlImageDownloader extends AbstractDownloader implements Downloader {

	private static final Logger logger = LoggerFactory.getLogger(CGR113_ADT_PlImageDownloader.class);
	...
	public void download(String target, String uid, Map<String, Object> params) throws Exception {
		...
		logger.info(String.format(">>>> CGR113_ADT_PlImageDownloader Start downloading from %s : %s", target, uid));
		...
		String fileName = CowayFtpFileName.getPLImgName(jobDate, jobType, orderNo, jobSeq, imgSeq);
