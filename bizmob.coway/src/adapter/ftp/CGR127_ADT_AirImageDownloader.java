...
@Component
public class CGR127_ADT_AirImageDownloader extends AbstractDownloader implements Downloader {

	private static final Logger logger = LoggerFactory.getLogger(CGR127_ADT_AirImageDownloader.class);
	...
	public void download(String target, String uid, Map<String, Object> params) throws Exception {
		...
		logger.info(String.format(">>>> CGR127_ADT_AirImageDownloader Start downloading from %s : %s", target, uid));
		...
		String filePath = CowayFtpFilePath.getAirFolder(orderNo);
		String fileName = CowayFtpFileName.getAirImgName(orderNo, imgSeq);
