...
public class CGR135_ADT_Nan5ImageDownloader extends AbstractDownloader implements Downloader {
	...
	private ILogger logger = LoggerService.getLogger(CGR135_ADT_Nan5ImageDownloader.class);
	...
	public void download(String target, String uid, Map<String, Object> params) throws Exception {
		...
		logger.info(String.format(">>>> CGR135_ADT_Nan5ImageDownloader Start downloading from %s : %s", target, uid));
		...
		String fileName = CowayFtpFileName.getWorkNan5ImgName(jobDate, jobType, orderNo, jobSeq, imgSeq);
