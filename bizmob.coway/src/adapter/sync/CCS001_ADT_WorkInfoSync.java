...
@Adapter(trcode = { "CCS001" })
public class CCS001_ADT_WorkInfoSync extends AbstractTemplateAdapter implements IAdapterJob {

	private static final Logger logger = LoggerFactory.getLogger(CCS001_ADT_WorkInfoSync.class);
	...
	public JsonAdaptorObject onProcess(JsonAdaptorObject obj) {
		...
		String[]		rfcNames			= {"ZSMT_IF_SP_CODY_RD006", "ZSMT_IF_SP_CODY_RD010", "ZSMT_IF_SP_CODY_RD011", "ZSMT_IF_SP_CODY_RD012"};
		try {		
			SapCommonMapperException 	commonMapper 	= new SapCommonMapperException(trCode, dbAdapter);
			long 						start 			= System.currentTimeMillis();
			Map<String, Object> 		resRD006Map 	= (Map<String, Object>) sapAdapter.execute("ZSMT_IF_SP_CODY_RD006", reqBodyNode, commonMapper); //ZSMT_IF_SP_CODY_RD006 - 서비스 목록 조회 (싱크)
			Map<String, Object> 		resRD010Map 	= (Map<String, Object>) sapAdapter.execute("ZSMT_IF_SP_CODY_RD010", reqBodyNode, commonMapper); //ZSMT_IF_SP_CODY_RD010 - 작업 상세 정보 조회 (싱크)
			Map<String, Object> 		resRD011Map 	= (Map<String, Object>) sapAdapter.execute("ZSMT_IF_SP_CODY_RD011", reqBodyNode, commonMapper); //ZSMT_IF_SP_CODY_RD011 - 도착등록 등록제약 바코드 조회 (싱크)
			Map<String, Object> 		resRD012Map 	= (Map<String, Object>) sapAdapter.execute("ZSMT_IF_SP_CODY_RD012", reqBodyNode, commonMapper); //ZSMT_IF_SP_CODY_RD012 - 하트서비스 고객별 스케줄 내역 조회 (싱크)
			...
			resBodyNode.put("CCR010", AdapterUtil.ConvertJsonNode(resRD010Map));
