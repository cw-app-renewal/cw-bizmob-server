...
public class CCS001_ADT_WorkInfoSync extends AbstractTemplateAdapter implements IAdapterJob {
	...
	public JsonAdaptorObject onProcess(JsonAdaptorObject obj) {
		...
		try {
			...
			logger.info("CCS001 Sync : " + reqBodyNode.toString());
			/*
			...
			logger.debug("CCS001 Sync : ZSMT_IF_SP_CODY_RD006 execute !!");
			/*
			 * ZSMT_IF_SP_CODY_RD010 - 작업 상세 정보 조회 (싱크)
			 */
			Map<String, Object> resRD010Map = (Map<String, Object>) sapAdapter.execute("ZSMT_IF_SP_CODY_RD010", reqBodyNode, commonMapper);
			logger.debug("CCS001 Sync : ZSMT_IF_SP_CODY_RD010 execute !!");
			/*
			...
			logger.debug("CCS001 Sync : ZSMT_IF_SP_CODY_RD011 execute !!");
			/*
			...
			logger.debug("CCS001 Sync : ZSMT_IF_SP_CODY_RD012 execute !!");			
