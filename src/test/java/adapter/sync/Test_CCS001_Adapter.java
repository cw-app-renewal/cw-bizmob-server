...
public class Test_CCS001_Adapter extends TestAdapter {

	@Autowired
	private CCS001_ADT_WorkInfoSync adapter;
	private JsonAdaptorObject obj = new JsonAdaptorObject();
	
	@Before
	public void setUp() throws IOException {
		//TODO 요청데이터 입력. JsonAdaptorObject.TYPE.REQUEST
		InputStream in = new FileInputStream(new File("./test/data/sync/CCS001.json"));
