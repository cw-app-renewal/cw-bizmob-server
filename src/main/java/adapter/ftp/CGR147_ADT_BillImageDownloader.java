...
@Component
public class CGR147_ADT_BillImageDownloader extends AbstractDownloader implements Downloader {

	private static final Logger logger = LoggerFactory.getLogger(CGR147_ADT_BillImageDownloader.class);
	...
	public void download(String target, String uid, Map<String, Object> params) throws Exception {
		...
		logger.info(String.format(">>>> CGR147_ADT_BillImageDownloader Start downloading from %s : %s", target, uid));
		...
		String fileName = CowayFtpFileName.getBillImgName(jobDate, jobType, orderNo, jobSeq, imgSeq);
