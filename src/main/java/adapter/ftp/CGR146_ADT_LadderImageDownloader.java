...
@Component
public class CGR146_ADT_LadderImageDownloader extends AbstractDownloader implements Downloader {

	private static final Logger logger = LoggerFactory.getLogger(CGR146_ADT_LadderImageDownloader.class);
	...
	public void download(String target, String uid, Map<String, Object> params) throws Exception {
		...
		logger.info(String.format(">>>> CGR146_ADT_LadderImageDownloader Start downloading from %s : %s", target, uid));
		...
		String fileName = CowayFtpFileName.getLadderImgName(jobDate, jobType, orderNo, jobSeq, imgSeq);
