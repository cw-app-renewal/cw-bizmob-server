...
public class CCS002_ADT_SchdInfoSync extends AbstractTemplateAdapter implements IAdapterJob {
	...
	private static final Logger logger = LoggerFactory.getLogger(CCS002_ADT_SchdInfoSync.class);
	...
	public JsonAdaptorObject onProcess(JsonAdaptorObject obj) {
		...
		String[]		rfcNames			= {"ZSMT_IF_SP_CODY_RD007", "ZSMT_IF_SP_CODY_RD045", "ZSMT_IF_SP_CODY_RD051"};
		...
		try {		
			...
			Map<String, Object> 		resRD007Map 	= (Map<String, Object>) sapAdapter.execute("ZSMT_IF_SP_CODY_RD007", reqBodyNode, commonMapper); //ZSMT_IF_SP_CODY_RD007 - 차용부품 정보 조회(싱크)
			Map<String, Object> 		resRD045Map 	= (Map<String, Object>) sapAdapter.execute("ZSMT_IF_SP_CODY_RD045", reqBodyNode, commonMapper); //ZSMT_IF_SP_CODY_RD045 - 소유권 이전대상 목록 조회(싱크)
			Map<String, Object> 		resRD051Map 	= (Map<String, Object>) sapAdapter.execute("ZSMT_IF_SP_CODY_RD051", reqBodyNode, commonMapper); //ZSMT_IF_SP_CODY_RD051 - 하트예정 목록 조회(싱크)
			Map<String, Object> 		resRD019Map 	= (Map<String, Object>) sapAdapter.execute("ZSMT_IF_SP_CODY_RD019", reqBodyNode, commonMapper); //ZSMT_IF_SP_CODY_RD019 - 조직정보 조회
