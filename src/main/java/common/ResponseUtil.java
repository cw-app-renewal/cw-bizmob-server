...
public class ResponseUtil {
    ...
    public static JsonAdaptorObject makeResponse(JsonAdaptorObject obj, JsonNode resNode, String trCode,
            long legacyTime, String rfcName, JsonNode reqBodyNode, String adtName) {
    ...
    public static JsonAdaptorObject makeResponse(JsonAdaptorObject obj, JsonNode resNode, String trCode,
            long legacyTime, JsonNode reqBodyNode, String adtName) {
    ...
    public static JsonAdaptorObject makeFailResponse(JsonAdaptorObject resObj, String errorCode, String errorMessage,
            String trCode, Object reqBody, String rfcName, Exception exception, String adtName) {
    ...
    public static JsonAdaptorObject makeFailResponse(JsonAdaptorObject resObj, String errorCode, String errorMessage,
            String trCode, Object reqBody, Exception exception, String adtName) {
...
enum APP {
    ...
    CODTANP0("svcMgr"), COCDANP0("cody"), COCDANP1("cody"), COCDANP2("svcMgr"), COWMANP0("smartSales"),
    COWMIOP0("smartSales"), COHCANP0("homeCareDr");
