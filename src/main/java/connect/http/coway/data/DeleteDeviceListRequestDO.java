...
public class DeleteDeviceListRequestDO {
	...
	public ArrayList<NameValuePair> getDeleteDeviceListNameValueLimitList() {
	...
	public ArrayList<NameValuePair> getDeleteDeviceListNameValueList() {
