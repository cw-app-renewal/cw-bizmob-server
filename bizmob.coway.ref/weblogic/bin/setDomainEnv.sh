...
# *************************************************************************
WL_HOME="/woongjin/domain/wlserver_10.3"
export WL_HOME

BEA_JAVA_HOME=""
export BEA_JAVA_HOME

SUN_JAVA_HOME="/usr/jdk1.6.0_33"
...
LONG_DOMAIN_HOME="/woongjin/domain/user_projects/domains/bizmob"
...
#JAVA_PROPERTIES="-Dplatform.home=${WL_HOME} -Dwls.home=${WLS_HOME} -Dweblogic.home=${WLS_HOME} -DSMART_HOME=${SMART_HOME} -Djava.awt.headless=true
