...
usage()
{
	...
	echo "for example:"
	echo "$1 managedserver1 http://wjcsmtwas1:7001"
}
...
ADMIN_URL="http://wjcsmtwas1:7001"
...
JAVA_OPTIONS="-Dweblogic.security.SSL.trustedCAKeyStore="/woongjin/domain/wlserver_10.3/server/lib/cacerts" ${JAVA_OPTIONS}"
export JAVA_OPTIONS
