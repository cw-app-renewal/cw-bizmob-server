...
usage()
{
	...
	echo "ADMIN_URL defaults to t3://wjcsmtwas1:7001 if not set as an environment variable or the second command-line parameter."
	...
	echo "for example:"
	echo "$1 managedserver1 t3://wjcsmtwas1:7001 weblogic weblogic"
}
