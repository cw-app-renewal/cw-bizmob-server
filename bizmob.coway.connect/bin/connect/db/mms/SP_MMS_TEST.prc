CREATE OR REPLACE PROCEDURE WJSMS.SP_MMS_TEST(
...
/*******************************************************************************************
  Descriptions   : 업무중에  발생된 긴급내용을 MMS_TEST로 전송
  Arguments      : MMS_TEST 전송
  History
********************************************************************************************
  작업일자      작성자     작업내용
********************************************************************************************
  2010/05/25    박성균     KT MMS_TEST 모듈 연동
********************************************************************************************/
IS
...
BEGIN
    ...
    WHEN OTHERS THEN
        v_rtn  := 9;
        v_msg  := '['||SQLCODE||']MMS_TEST전송내역 생성중  에러:[SVC] ' ||v_rsrvd_id;
        --v_msg  := '[]MMS_TEST전송내역 생성중  에러:[SVC] ' ||v_rsrvd_id;
