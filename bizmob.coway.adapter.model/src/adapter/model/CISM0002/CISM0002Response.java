...
public class CISM0002Response {
	...
	* body object
	*/
	private CISM0002Response_Body body = null;

	public CISM0002Response() {
	}

	public CISM0002Response(JsonAdaptorObject obj) {
		JsonNode rootNode = obj.get(JsonAdaptorObject.TYPE.RESPONSE);
		JsonNode headerNode = rootNode.path("header");
		this.header = new CowayCommonHeader(headerNode);
		JsonNode bodyNode = rootNode.path("body");
		this.body = new CISM0002Response_Body(bodyNode);
	}
	...
	@JsonProperty("body")
	public CISM0002Response_Body getBody() {
		return this.body;
	}

	public void setBody(CISM0002Response_Body body) {
		this.body = body;
	}
	...
	public String toString() {
		...
		builder.append("CISM0002Response [");
