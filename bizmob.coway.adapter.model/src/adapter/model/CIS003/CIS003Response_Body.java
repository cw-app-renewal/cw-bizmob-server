 ...
 * Comment
 */
public class CIS003Response_Body {
	/**
	* 제품 시리얼 번호
	*/
	...
	* 스마트진단항목유형
	*/
	private List<CIS003Response_Body_itemTypes> itemTypes = new ArrayList<CIS003Response_Body_itemTypes>();
	/**
	...
	*/
	...
	public CIS003Response_Body() {
	}

	public CIS003Response_Body(JsonNode jsonNode) {
	...
	public List<CIS003Response_Body_itemTypes> getItemTypes() {
		return this.itemTypes;
	}

	public void setItemTypes(List<CIS003Response_Body_itemTypes> itemTypes) {
	...
	public String toString() {
		...
		builder.append("CIS003Response_Body [");
