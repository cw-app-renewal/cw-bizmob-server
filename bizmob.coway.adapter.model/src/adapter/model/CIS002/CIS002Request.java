...
public class CIS002Request {
	...
	* body object
	*/
	private CIS002Request_Body body = null;

	public CIS002Request() {
	}

	public CIS002Request(JsonAdaptorObject obj) {
		JsonNode rootNode = obj.get(JsonAdaptorObject.TYPE.REQUEST);
		JsonNode headerNode = rootNode.path("header");
		this.header = new CowayCommonHeader(headerNode);
		JsonNode bodyNode = rootNode.path("body");
		this.body = new CIS002Request_Body(bodyNode);
	}
	...
	@JsonProperty("body")
	public CIS002Request_Body getBody() {
		return this.body;
	}

	public void setBody(CIS002Request_Body body) {
		this.body = body;
	}
