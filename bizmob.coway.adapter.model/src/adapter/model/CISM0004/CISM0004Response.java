...
public class CISM0004Response {
	...
	* body object
	*/
	private CISM0004Response_Body body = null;

	public CISM0004Response() {
	}

	public CISM0004Response(JsonAdaptorObject obj) {
		JsonNode rootNode = obj.get(JsonAdaptorObject.TYPE.RESPONSE);
		JsonNode headerNode = rootNode.path("header");
		this.header = new CowayCommonHeader(headerNode);
		JsonNode bodyNode = rootNode.path("body");
		this.body = new CISM0004Response_Body(bodyNode);
	}
	...
	@JsonProperty("body")
	public CISM0004Response_Body getBody() {
		return this.body;
	}

	public void setBody(CISM0004Response_Body body) {
		this.body = body;
	}
	...
	public String toString() {
		...
		builder.append("CISM0004Response [");
