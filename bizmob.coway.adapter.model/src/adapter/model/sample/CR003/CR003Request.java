...
public class CR003Request {
	 ...
	 * body object
	 */
	private CR003Request_Body body;

	public CR003Request() {
	}

	public CR003Request(JsonAdaptorObject obj) {
		JsonNode rootNode = obj.get(JsonAdaptorObject.TYPE.REQUEST);
		JsonNode headerNode = rootNode.path("header");
		this.header = new HWHeader(headerNode);
		JsonNode bodyNode = rootNode.path("body");
		this.body = new CR003Request_Body(bodyNode);
	}
	...
	public CR003Request_Body getBody() {
		return this.body;
	}

	public void setBody(CR003Request_Body body) {
		this.body = body;
	}
